        ...
        <div className="bg-slate-300 mt-10 w-4/5 mx-auto p-5">
            ...
            <div className='grid grid-cols-7 gap-4'>
                {role == "admin"  ? (
                    ...
                    <Link href="/" className='col-span-3 mt-2 flex items-center justify-center w-full bg-slate-800 text-center text-white p-4 hover:bg-slate-900'>
                        Regresar
                    </Link>
                )}
                <Link href="/admins/certificates/new" className='col-span-3 mt-2 flex items-center justify-center w-full bg-green-500 text-center text-white p-4 hover:bg-green-600'>
                    Habilitar usuario
                </Link>
