                        ...
                        <div className="mt-2">
                            ...
                            {!isBought  ? (
                                <Link href="" className="bg-slate-800 text-slate-300 w-full text-lg text-center mt-2 p-2  hover:bg-slate-900 flex justify-between">
                                    ...
                                    <button onClick={() => handleCartAndRedirect(course)} className="hover:scale-125 transition-all" title="Añadir al carrito">
                                ...
                                <Link href="/course/details/98" className="bg-slate-800 text-slate-300 w-full text-lg text-center mt-2 p-2  hover:bg-slate-900 flex justify-center">
                                    Estudiar
                                </Link>
                            )
                            }
