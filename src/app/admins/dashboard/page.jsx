  ...
  return (
    <div className="bg-slate-300 p-4 lg:w-4/5 mx-auto mt-10">
      ...
      <div className="grid grid-cols-10 gap-4 mt-4">
        ...
        <Link  href={"/admins/users"} className="col-span-5 lg:col-span-2 border flex justify-center items-center bg-indigo-500 p-4 hover:bg-indigo-600 transition-all">
        ...
        <Link  href={"/admins/certificates"} className="col-span-10 lg:col-span-2 border flex justify-center items-center bg-pink-500 p-4 hover:bg-pink-600 transition-all">
