...
const page = () => {
  ...
  return (
    <div className='bg-slate-300 p-4 w-4/5 mx-auto mt-10'>
      ...
      <div>
        <h2 className="text-center text-sm text-slate-500 w-1/2 mx-auto">Una vez seamos notificados de la transaccion, haremos el resto del trabajo, no te preocupes ;), mientras tanto puedes...</h2>
        <div className="w-1/2 flex justify-center mx-auto mt-4">
          <Link href={"/"} className=" bg-slate-800 hover:bg-slate-900 text-center p-2 text-white">Volver al inicio</Link>
        </div>
      </div>
    </div>
  )
