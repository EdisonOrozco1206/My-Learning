  ...
  return (
    <div className='bg-slate-300 p-4 w-full lg:w-4/5 mx-auto mt-10'>
      ...
      <div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col lg:flex-row justify-between mx-auto mt-4 gap-4 lg:gap-0">
          <button onClick={clearCartAndRedirect} className="border border-slate-800 text-black hover:bg-slate-900 text-center p-4 lg:p-2 hover:text-white">Volver al inicio</button>
          <Link href={"/cart"} className="bg-slate-800 hover:bg-slate-300 text-center p-4 lg:p-2 text-white hover:border  hover:text-black border-slate-800">Reintentar pago</Link>
        </div>
      </div>
    </div>
  )
