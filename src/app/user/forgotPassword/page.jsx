  ...
  return (
    <div className='mt-10 lg:w-2/5 mx-auto'>
      <form action={sendRecoveryEmail} className='border p-6'>
        ...
        <p className="text-sm block w-5/6 mx-auto mt-4">Ingresa el correo asociado a tu cuenta y allí te enviaremos un correo para la recuperación de tu contraseña</p>
