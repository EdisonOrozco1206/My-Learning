...
const HomePage = () => {
  return <>
    <div className="bg-slate-800 text-white dynamic-text flex items-center justify-center text-center mt-10 h-32 overflow-hidden">
      <p className="text-1 text-3xl">
    ...
    <div className="w-4/5 mx-auto mt-10 flex flex-row justify-between items-center">
      ...
      <div className="ml-10 w-1/2">
        ...
        <a href="" className="bg-slate-800 text-white p-4 text-2xl hover:bg-slate-600">Empieza a enseñar en My Learning</a>
      </div>
    </div>
  </>
}
